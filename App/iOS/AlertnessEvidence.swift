...
enum AlertnessEvidence {
    ...
    static let references: [Reference] = [
        ...
        Reference(id: 3,
                  text: "Cantelon (2021), Frontiers in Psychology — review of cognitive changes during acute aerobic exercise.",
                  url: URL(string: "https://doi.org/10.3389/fpsyg.2021.653158")),
        Reference(id: 4,
    ...
    static let factors: [Factor] = [
        ...
        Factor(icon: "figure.walk", tint: .green, title: "Movement",
               ...
               claim: "A brisk walk gives a small, fairly immediate lift in alertness and reaction time, and acts as a daily timing cue for your body clock.",
               cites: [3]),
